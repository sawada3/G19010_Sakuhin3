...
#define IMAGE_START_TITLE		TEXT(".\\IMAGE\\Title.png")
#define IMAGE_START_ROGO		TEXT(".\\IMAGE\\ROGO.png")
...
VOID MY_START_PROC(VOID)
{
	...
	{
		if (Title.image.y < GAME_HEIGHT / 2)
		{
			Title.IsDraw = TRUE;
			Title.image.y += 1;
		}
